...
namespace ModelProject.Migrations
{
    ...
    [Migration("20241210150909_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ModelProject.Model.DigitalModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ModelProject.Model.Follow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ModelProject.Model.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ModelProject.Model.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ModelProject.Model.Like", b =>
                {
                    b.HasOne("ModelProject.Model.DigitalModel", "DigitalModel")
                        .WithMany()
